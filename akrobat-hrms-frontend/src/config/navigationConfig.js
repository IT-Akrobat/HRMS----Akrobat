...
export const NAVIGATION_CONFIG = {
  ...
  [ROLES.MANAGER]: [
    ...
    },
    {
      ...
      icon: Palmtree,
      children: [
        { label: 'Pending Approvals', path: '/manager/leave/pending' },
  ...
  [ROLES.HR_ADMIN]: [
    ...
    },
    {
      ...
      icon: Palmtree,
      children: [
        { label: 'Leave Requests', path: '/hr-admin/leave/requests' },
    ...
    },
    {
      ...
      icon: Wallet,
      children: [
        { label: 'Salary Structure', path: '/hr-admin/payroll/salary-structure' },
        { label: 'Generate Payslip', path: '/hr-admin/payroll/generate-payslip' },
  ...
  [ROLES.SUPER_ADMIN]: [
    ...
    },
    {
      ...
      icon: Building2,
      children: [
        { label: 'Company Profile', path: '/super-admin/organization/company-profile' },
    ...
    },
    {
      ...
      icon: ShieldCheck,
      children: [
        { label: 'Login Activity', path: '/super-admin/security/login-activity' },
        { label: 'Audit Logs', path: '/super-admin/security/audit-logs' },
        { label: 'Access Control', path: '/super-admin/security/access-control' },
      ],
    },
    {
      ...
      icon: KeyRound,
      children: [
        { label: 'Configurations', path: '/super-admin/system-settings/configurations' },
        { label: 'Integrations', path: '/super-admin/system-settings/integrations' },
      ],
    },
